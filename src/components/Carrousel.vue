    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://wallpaperaccess.com/full/25484.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Game of Thrones</h5>
                    <p>Disponible en HBO Max</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://images6.alphacoders.com/119/thumb-1920-1191374.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>El Juego del Calamar</h5>
