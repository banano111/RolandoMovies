    ...
    <main class="d-flex flex-nowrap vh-100">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <router-link class="nav-link link-light" to="/search" aria-current="page">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-search mx-1" viewBox="0 0 16 16">
                            <path
                ...
                <li>
                    <router-link class="nav-link link-light" to="/mySeries" aria-current="page">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-tv mx-1" viewBox="0 0 16 16">
                            <path
                ...
                <li>
                    <router-link class="nav-link link-light" to="/mostViews" aria-current="page">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-trophy mx-1" viewBox="0 0 16 16">
                            <path
